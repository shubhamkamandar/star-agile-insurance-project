node{
    ...
    stage('git code checkout'){
        try{
            ...
            git 'https://github.com/shubhamkamandar/star-agile-insurance-project'
        }
        catch(Exception e){
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t shubham123/insure-me:${tagName} ."
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} push shubham123/insure-me:${tagName}"
